...
InModuleScope PSStarr {
    Describe 'Sonarr bulk series tag changes' {
        ...
        It 'adds tags with a narrow body and preserves response objects' {
            $result = @(Set-StarrSonarrSeriesTag -Name Main -SeriesId 42,43 -TagId 7 -ApplyTags Add -Confirm:$false)
            ...
            Should -Invoke Invoke-StarrApiRequest -Times 1 -Exactly -ParameterFilter {
                ...
                $ExpectedApplication -eq 'Sonarr' -and $Name -eq 'Main' -and $Body.Count -eq 3 -and
        ...
        It 'does not contact the server under WhatIf' {
            Set-StarrSonarrSeriesTag -Name Main -SeriesId 42 -TagId 7 -ApplyTags Remove -WhatIf
        ...
        It 'rejects invalid identifiers and replacement before transport' {
            ...
            { Set-StarrSonarrSeriesTag -Name ' ' -SeriesId 42 -TagId 7 -ApplyTags Add } | Should -Throw
