function Get-StarrTask {
    ...
    .DESCRIPTION
        This function retrieves system tasks from an inferred or named Starr instance, or from an explicit URL and API key.
    ...
    .PARAMETER TaskId
        The positive Task resource identifier used for an individual lookup.

    .EXAMPLE
        Get-StarrTask

    .EXAMPLE
        Get-StarrTask -Name 'Main'
    ...
    if ($PSBoundParameters.ContainsKey('TaskId')) {
        $request.Endpoint = "$endpoint/$TaskId"
    }
