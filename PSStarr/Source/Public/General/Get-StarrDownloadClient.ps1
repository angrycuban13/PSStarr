function Get-StarrDownloadClient {
    ...
    .DESCRIPTION
        This function retrieves download clients from an inferred or named Starr instance, or from an explicit URL and API key.
    ...
    .EXAMPLE
        Get-StarrDownloadClient -Name 'Main'
