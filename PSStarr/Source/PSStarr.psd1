...
@{
    ...
    Copyright            = '(c) 2026 AngryCuban13. Licensed under the MIT License.'
    ...
    FormatsToProcess     = @('PSStarr.Format.ps1xml')
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Initial 1.0.0 release. See https://github.com/angrycuban13/PSStarr/blob/main/CHANGELOG.md.'
